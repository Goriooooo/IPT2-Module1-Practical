...
const Checkout = () => {
  ...
  // Initialize phone number from userData
  useEffect(() => {
    if (userData?.phone) {
      setFormData(prev => ({
        ...prev,
                  ...
                  <div className="space-y-2">
                    ...
                    {userData?.phone && (
                      <button
                        ...
                        onClick={() => {
                          setUseCustomPhone(false);
                          setFormData(prev => ({ ...prev, phoneNumber: userData.phone }));
                        }}
                        className="text-xs text-amber-700 hover:text-amber-900 underline"
                      >
                        Use saved number ({userData.phone})
                      </button>
                    )}
                  </div>
                )}
