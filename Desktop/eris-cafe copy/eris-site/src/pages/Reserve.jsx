          ...
          <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-4 sm:p-6 space-y-3 sm:space-y-4">
              ...
              <div>
                ...
                {user?.phone && !useCustomPhone ? (
                  <div className="space-y-2">
                    <div className="flex items-center justify-between px-3 sm:px-4 py-2 bg-amber-50 border border-amber-200 rounded-lg">
                      <div>
                        <p className="text-xs text-gray-600">Saved Number</p>
                        <p className="text-sm sm:text-base font-semibold text-gray-900">{user.phone}</p>
                      </div>
                      <button
                        type="button"
                        onClick={() => {
