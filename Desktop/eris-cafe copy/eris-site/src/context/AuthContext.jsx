...
export const AuthProvider = ({ children }) => {
  ...
  const refreshUserData = async () => {
    try {
      ...
      // Decode the current token (which should have been updated by update-profile)
      const decodedToken = jwtDecode(token);
      ...
      console.log('User data refreshed from token:', decodedToken);
      return { success: true, userData: decodedToken };
    } catch (err) {
