...
import { User, Mail, Phone, MapPin, Calendar, Save, Database, Upload, Download, Cloud, Trash2 } from 'lucide-react';
...
const AdminProfile = () => {
  ...
  const handleDeleteBackup = async (backupFile) => {
    const result = await Swal.fire({
      title: 'Delete Backup?',
      html: `<p>Are you sure you want to delete this backup?</p><p class="font-bold mt-2">${backupFile}</p><p class="text-red-600 mt-2">⚠️ This action cannot be undone!</p>`,
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#DC2626',
      cancelButtonColor: '#6B7280',
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="px-3 py-1 text-sm bg-red-100 text-red-700 rounded hover:bg-red-200 transition disabled:opacity-50 flex items-center gap-1"
                          >
