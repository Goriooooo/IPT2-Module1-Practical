...
const ProductAnalytics = () => {
  ...
  const calculatePerformance = (quantitySold, daysSinceLastOrder, isAvailable) => {
    ...
    if (quantitySold >= 20) return 'best-seller';
    if (quantitySold >= 10) return 'good';
    if (quantitySold >= 5) return 'moderate';
  ...
  const exportBestSellersReport = (format) => {
    ...
    if (format === 'pdf') {
      ...
      csvContent = addCSVSignature(csvContent, 'Best Sellers Report');
  ...
  const exportLowPerformersReport = (format) => {
    ...
    if (format === 'pdf') {
      ...
      csvContent = addCSVSignature(csvContent, 'Low Performers Report');
  ...
  const exportAllProductsReport = (format) => {
    ...
    if (format === 'pdf') {
      ...
      csvContent = addCSVSignature(csvContent, 'Complete Product Report');
      const blob = new Blob([csvContent], { type: 'text/csv;charset=utf-8;' });
      const link = document.createElement('a');
  ...
  const totalUnitsSold = productStats.reduce((sum, p) => sum + p.totalQuantitySold, 0);
  const bestSellersRevenue = bestSellers.reduce((sum, p) => sum + p.totalRevenue, 0);
  const lowPerformersRevenue = lowPerformers.reduce((sum, p) => sum + p.totalRevenue, 0);
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-green-600">₱{bestSellersRevenue.toFixed(2)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-red-600">₱{lowPerformersRevenue.toFixed(2)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-blue-600">{totalUnitsSold} units sold</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-emerald-600">From all products</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-800">₱{totalProfit.toFixed(2)}</h3>
                <p className="text-xs text-amber-600">Estimated margin</p>
              </div>
            </div>
          </div>
        </div>
